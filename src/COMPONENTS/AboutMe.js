        ...
        <div className={styles.sectionContainer}>
           ...
           <div className={styles.aboutMeContainer}>
               ...
               <div className={styles.aboutMeTextWrapper}>
                <div className={styles.aboutMeTextContainer} data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="100"> 
                ...
                <div className={styles.aboutMeTextContainer} data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="1500"> 
